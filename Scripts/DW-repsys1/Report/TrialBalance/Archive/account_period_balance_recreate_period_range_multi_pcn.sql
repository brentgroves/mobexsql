...
--declare @prev_period int;
--set @start_period = 202101;
if ((@period_start%100)!=1)
begin
	set @prev_period = @period_start - 1;
end
else
begin
	set @prev_period = (((@period_start/100)-1)*100)+12;
end;
-- select @start_period start_period,@prev_period prev_period;
