...
-- Validation.restrictions2 definition

-- Drop table

-- DROP TABLE Validation.restrictions2;
CREATE TABLE Validation.restrictions2 (
...
insert into Validation.restrictions2 values('user1', 'job1','item1')
