...
where sh.script_key in (1,3,4,5,6,7,8,9,116,117)
and start_time > '2022-09-02' 
order by script_history_key desc

/*
 * k8s validation
 */
select count(*) from Validation.Detailed_Production_History
/*
 * Definitions
 */
select distinct pcn,(year)  from Plex.accounting_account_year_category_type aayct order by pcn,year
select count(*) from Plex.accounting_account_year_category_type aayct  -- 33096,24,811, 24,767, 24,723
WHERE year = 2022 -- 8,285
select * from Plex.accounting_account_year_category_type aayct  -- 24,767, 24,723
where revenue_or_expense = 1
select distinct pcn,account_no from Plex.accounting_account aa order by pcn,account_no 
select distinct pcn from Plex.accounting_account aa order by pcn 
...
-- delete from Plex.accounting_period  
select distinct pcn from Plex.accounting_period ap 
select count(*) from Plex.accounting_period ap -- 1276/638,2836/1418
-- where ordinal = 0 -- 638
where ordinal = 1 -- 638
select * from Plex.accounting_period
where pcn = 123681 and period between 202107 and 202207 -- 2022-06-03 19:50:00.000
order by pcn,period 
...
select count(*) from Plex.accounting_balance ab -- 7,172/4,427
select distinct pcn, period from Plex.accounting_balance ab2 
where period between 202107 and 202206
order by pcn,period 
...
select * 
-- select count(*)
from Plex.account_activity_summary  -- 16,570/9234,8282/4617
-- where pcn = 123681 -- 9,234
where pcn = 300758  -- 7,336

-- and period = 202207 -- 3668
and period = 202208 -- 3668
...
select * 
-- into Archive.account_period_balance_2022_07_13 -- 148998
from Plex.account_period_balance

select distinct pcn,period from Plex.account_period_balance order by pcn,period 
select count(*) from Plex.account_period_balance apb -- 161,900/157,283/101,879,148,998,140,713/ 132,428,123,659,131,900, 123,615
where period = 202207 -- 8,285
select * from Plex.account_period_balance apb -- 131,900, 123,615
where account_no like '73250%' --22 73250 
and pcn = 123681 order by account_no 

select count(*) from Plex.account_period_balance apb -- 161,900/157,283/101,879,148,998,140,713/ 132,428,123,659,131,900, 123,615
-- where period = 202206 -- 8,285
where pcn = 123681
and period between 202207 and 202208 -- 9234
and period = 202207 -- 4617
and period = 202207 -- 4617

select * 
-- select count(*)
from Plex.account_activity_summary -- 4617/8285
...
select count(*) from Plex.accounting_account_year_category_type aayct  -- 24,811,24,723
select * 
...
9. Validate period balance calculations from Plex.account_period_balance_validate  
...
where pcn=@pcn
and period between 202101 and 202206  --2022-07-15 11:56:00.000,2022-06-03 19:50:00.000
order by period 
select *
from Plex.accounting_period ap 
where pcn=123681
...
-- into Archive.Script_History_06_06
from ETL.script_history sh 
where script_key in (1,3,4,5,6,7,8,9,116,117)
and start_time > '2022-07-25' 
order by script_history_key desc


select count(*) from Plex.accounting_account_year_category_type aayct  -- 24,811/16,526, 24,767, 24,723
...
select * from Plex.accounting_period
where pcn = 123681 and period between 202201 and 202206 -- 2022-07-21 15:14:00,2022-07-15 11:56:00.000
order by pcn,period 
...
select count(*) from Plex.accounting_balance ab -- 7,172
...
select * 
-- select count(*)
from Plex.account_activity_summary  -- 313

select count(*) from Plex.accounting_account_summary_open_period -- 449/385/381/375/313/311
select * from Plex.accounting_account_summary_open_period  -- 311

-- exec Plex.account_period_balance_delete_period_range
select count(*) from Plex.account_period_balance apb -- 157,283/57,863,149,624,148,998/140,713/100,365 132,428,123,659,131,900, 123,615
where period = 202207  -- 8,285

57,863 - 49,578 = 8,285
select count(*) 
from Plex.account_period_balance apb -- 157,283/57,863/ 149,624,148,998/140,713/100,365 132,428,123,659,131,900, 123,615
where pcn=123681
 ...
 */
select count(*)
from Azure.account_period_balance  -- 157,283/202207,148,998

select count(*)
from Plex.account_period_balance  -- 157,283/202207,148,998
...
select count(*) from Azure.account_period_balance -- 157,283
...
where p.pcn = 123681 -- 87,657
and p.period between 202101 and 202207 -- 87,657/83,040
and p.period_display = a.period_display -- 157,283 
and p.debit = a.debit  -- 157,283 
and p.credit  = a.credit  -- 157,283 
and p.balance  = a.balance  -- 157,283 
and p.ytd_debit = a.ytd_debit -- 157,283
and p.ytd_credit  = a.ytd_credit  -- 157,283
and p.ytd_balance  = a.ytd_balance  -- 157,283
and p.period = 202207
and p.pcn = 123681
...
where b.period between @period_start and @period_end -- 148,998, 140,713/2021-01 to 2022-05
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end  --83,040/2022-06/78,423/2021-01 to 2022-05, 73,806/2021-01 to 2022-04/68,925/2021-01 to 2022-03 -- 69,189
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end and p.pcn is not null -- 75,672/2022-06,71,468/2021-01 to 2022-05, 67,264/2021-01 to 2022-04, 63,060/2021-01 to 2022-03
-- where b.pcn=@pcn and b.period between @period_start and @period_end and p.pcn is null and s.pcn is not null  --60/2022-06,56/2021-01 to 2022-05, 53/2021-01 to 2022-04 --5/2021-01 to 2022-03 -- 47/2021-01 to 2022-03 --42/2021-01 to 2022-01 -- 38/2021-01 to 2021-12  account periods with activity not on the TB report.


-- where b.pcn=@pcn and b.period between @period_start and @period_end and s.pcn is not null  --4,433/2022-06, 4,190/2021-01 to 2022-05-pulled-06-14,--4,186/2021-01 to 2022-05-pulled-06-04 --4,177/2021-01 to 2022-05--3,953/2021-01 to 2022-04 --3,696/2021-01 to 2022-03 --3,446/2021-01 to 2022-02-- 3,217/2021-01 to 2022-01 -- 2,975/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.debit=s.debit  --4,433/2022-06,4,190/2021-01 to 2022-05-pulled-06-14--4,186/2021-01 to 2022-05-pulled-06-04--4,177/2021-01 to 2022-05--3,953/2021-01 to 2022-04 --3,696/2021-01 to 2022-03 --3,446/2021-01 to 2022-02-- 3,217/2021-01 to 2022-01 -- 2,975/2021-01 to 2021-12
...
--where b.pcn=@pcn and b.period between @period_start and @period_end and b.credit = s.credit  --4,433/2022-06,4,190/2021-01 to 2022-05-pulled-06-14--4,186/2021-01 to 2022-05-pulled-06-04--4,177/2021-01 to 2022-05--3,953/2021-01 to 2022-04 -- 3,696/2021-01 to 2022-03 -- 2,975/2021-01 to 2021-12
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.balance =s.balance  --4,433/2022-06,4,190/2021-01 to 2022-05-pulled-06-14--4,186/2021-01 to 2022-05-pulled-06-04--4,177/2021-01 to 2022-05--3,953/2021-01 to 2022-04 -- 3,696/2021-01 to 2022-03 -- 2,975/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.balance !=s.balance -- 0

-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.balance = d.current_debit_credit  --75,636/2022-6,71,432/2021-01 to 2022-05 --67,228/2021-01 to 2022-04 --63,028/2021-01 to 2022-03 --50,423/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.balance != d.current_debit_credit  -- 36/2022-06,36/2021-01 to 2022-05 -- 36/2021-01 to 2022-04 -- 32/2021-01 to 2022-03 -- 25/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and (b.balance - d.current_debit_credit) >  0.01 -- 0/2022-06,0/2021-01 to 2022-05-- 0/2021-01 to 2022-04 -- 0/2021-01 to 2022-03 -- 0/2021-01 to 2021-12
--where a.account_no = '22500-000-0000' and b.period=202203

-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.credit = p.current_credit  -- 75,672/0,71,468/2021-01 to 2022-05-- 67,264/2021-01 to 2022-04 -- 63,060/2021-01 to 2022-03 --50,448/2021-01 to 2021-12
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.debit = p.current_debit  -- 75,672/2022-06,71,468/2021-01 to 2022-05-- 67,264/2021-01 to 2022-04-- 63,060/2021-01 to 2022-03 -- 50,448/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.debit != p.current_debit  -- 0/2022-06,0/2021-01 to 2022-01 -- 0 
--22600-000-0000, 22900-000-0000 signs are reversed

-- where b.pcn=@pcn and b.period between @period_start and @period_end and (b.balance = p.Current_Debit - p.Current_Credit)  -- 75,672/2022-06,71,468/2021-01 to 2022-05-- 67,264/2021-01 to 2022-04 -- 63,056/2021-01 to 2022-03 -- 50,448/2021-01 to 2021-12
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.ytd_credit = p.ytd_credit  -- 75,666/2022-06,71,463/2021-01 to 2022-05-- 67,260/2021-01 to 2022-04-- 63,057/2021-01 to 2022-03 -- 50,448/2021-01 to 2021-12--
-- START ISSUE
--  where b.pcn=@pcn and b.period between @period_start and @period_end and b.ytd_credit = p.ytd_credit  -- 74,112/2022-06,71,463/2021-01 to 2022-05-- 67,260/2021-01 to 2022-04-- 63,057/2021-01 to 2022-03 -- 50,448/2021-01 to 2021-12--
-- WHAT ACCOUNTS ARE NOT EQUAL?
--  where b.pcn=@pcn and b.period between @period_start and @period_end and b.ytd_credit != p.ytd_credit  -- 6/2022-06,5/2021-01 to 2022-05-- 4/2021-01 to 2022-04 -- 3/2021-01 to 2021-12
-- was regenerate changed? yes. 7-14
-- what changed? nothing since back to 628
  -- is DevOps the same as github? yes 
...
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.ytd_debit = p.ytd_debit  -- 75,666/2022-06,71,463/2021-01 to 2022-05-- 67,260/2021-01 to 2022-04--63,053/2021-01 to 2022-03 -- 50,448/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and b.ytd_debit != p.ytd_debit  -- 6/2022-06,5/2021-01 to 2022-05-- 4/2021-01 to 2022-04 -- 3/2021-01 to 2022-03 -- 0/2021-01 to 2021-12
-- ISSUE: 1 ACCOUNT IS NOT THE SAME
-- See issue section at the bottom of this procedure and the Mobex Plex procedure: accounting_year_category_type_issue 
-- 73100-000-0000 has different category_types in accounting_v_account it is an Expense and in accounting_v_category_type it is a liability
-- Conclusion: The Plex TB report and Plex authored procedure is wrong to not reset YTD values.
-- WHere b.pcn=@pcn and b.period between @period_start and @period_end and (d.ytd_debit_credit = (p.ytd_debit-p.ytd_credit))  --75,443/2022-06,71,248/2021-01 to 2022-05-pulled-06-14--71,250/2021-01 to 2022-05-pulled-06-04--71,249/2021-01 to 2022-05--67,056/2021-01 to 2022-04 --62,861/2021-01 to 2022-01 -- 50,286/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and (d.ytd_debit_credit != (p.ytd_debit-p.ytd_credit))  --229/2022-06,220/2021-01 to 2022-05-pulled-06-14--218/2021-01 to 2022-05-pulled-06-04--219/2021-01 to 2022-05--208/2021-01 to 2022-04 --199/2021-01 to 2022-01 -- 162/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and (((p.ytd_debit-p.ytd_credit) - d.ytd_debit_credit) > 0.01 or ((p.ytd_debit-p.ytd_credit) - d.ytd_debit_credit) < -0.01)   -- 0/2022-06,0/2021-01 to 2022-04 -- 0/2021-01 to 2022-03 

-- where b.pcn=@pcn and b.period between @period_start and @period_end and (b.ytd_balance = d.ytd_debit_credit) --75,437/2022-06,71,243/2021-01 to 2022-05-pulled-06-14--71,245/2021-01 to 2022-05-pulled-06-04 --71,244/2021-01 to 2022-04--67,052/2021-01 to 2022-04 67,052/2021-01 to 2022-03-- 62,860/2021-01 to 2022-03 -- 50,286/2021-01 to 2021-12
-- where b.pcn=@pcn and b.period between @period_start and @period_end and (b.ytd_balance != d.ytd_debit_credit) --235/2022-06,225/2021-01 to 2022-05-pulled-06-14--223/2021-01 to 2022-05-pulled-06-04-- 224/2021-01 to 2022-05-- 212/2021-01 to 2022-04-- 200/2021-01 to 2022-01 -- 162/2021-01 to 2021-12

 where b.pcn=@pcn and b.period between @period_start and @period_end and ((b.ytd_balance - d.ytd_debit_credit) > 0.01 or (b.ytd_balance - d.ytd_debit_credit) < -0.01)  -- 6/2022-06, 5/2021-01 to 2022-05 -- 4/2021-01 to 2022-04-- 3/2021-01 to 2022-03
  -- Which are not equal?
 202107 27800-000-9802	-20756485.18000	-8948922.46	-8948922.46
202107	27800-000-9804	-162823369.28000	-9663750.56	-9663750.55
202107	27800-000-9806	-98824.06000	-4228.06	-4228.06
202107	27800-000-9808	-6347623.70000	-191673.50	-191673.50
202107	27800-000-9809	-1140554.00000	-11934.00	-11934.00
202107	27800-000-9810	-1992688.32000	-9600.00	-9600.00
-- Is the ytd values correct in 202106: yes
select period,account_no,ytd_debit,ytd_credit,ytd_balance  from Plex.account_period_balance apb where account_no in
('27800-000-9802','27800-000-9804','27800-000-9806','27800-000-9808','27800-000-9810')
and pcn = 123681
and period = 202106
order by account_no
202106	27800-000-9802	-62880998.85000	-56163787.16000	-6717211.69000
202106	27800-000-9804	38921141.95000	46563095.10000	-7641953.15000
202106	27800-000-9806	360423.01000	364346.08000	-3923.07000
202106	27800-000-9808	-802930.77000	-741280.63000	-61650.14000
202106	27800-000-9810	0.00000	0.00000	0.00000

select period,account_no,ytd_debit,ytd_credit,ytd_balance  from Plex.trial_balance tb  where account_no in
('27800-000-9802','27800-000-9804','27800-000-9806','27800-000-9808','27800-000-9810')
and pcn = 123681
and period = 202106
order by account_no
...
What is added in period 202107 to get wrong ytd values? 
select period,account_no, debit,credit,balance from Plex.accounting_balance  where account_no  in
('27800-000-9802','27800-000-9804','27800-000-9806','27800-000-9808','27800-000-9810')
and pcn = 123681
and period = 202107
order by account_no 
202107	27800-000-9802	0.00000	2231710.77000	-2231710.77000
202107	27800-000-9804	0.00000	2021797.41000	-2021797.41000
202107	27800-000-9806	26693.28000	26998.27000	-304.99000
202107	27800-000-9808	0.00000	130023.36000	-130023.36000
202107	27800-000-9810	0.00000	9600.00000	-9600.00000
...
and period = 202107
order by account_no
202107	27800-000-9802	-62880998.85000	-53932076.39000	-8948922.46000
202107	27800-000-9804	38921141.95000	48584892.51000	-9663750.56000
202107	27800-000-9806	387116.29000	391344.35000	-4228.06000
202107	27800-000-9808	-802930.77000	-611257.27000	-191673.50000
202107	27800-000-9810	0.00000	9600.00000	-9600.00000
...
and period = 202107
order by account_no
202107	27800-000-9802	-62880998.85000	-42124513.67000	-20756485.18000
202107	27800-000-9804	41431297.95000	204254667.23000	-162823369.28000
202107	27800-000-9806	900049.41000	998873.47000	-98824.06000
202107	27800-000-9808	-802930.77000	5544692.93000	-6347623.70000
202107	27800-000-9810	0.00000	1992688.32000	-1992688.32000

The algorithm looks correct so why does the ytd_balances differ?

Does mysql give the same results as mssql?
select period,account_no,ytd_debit,ytd_credit,ytd_balance  from Plex.account_period_balance apb where account_no in
('27800-000-9802','27800-000-9804','27800-000-9806','27800-000-9808','27800-000-9810')
and pcn = 123681
and period = 202106
...
and period = 202107
order by account_no
202107	27800-000-9802			
202107	27800-000-9804			
202107	27800-000-9806			
202107	27800-000-9808			
202107	27800-000-9810			nulls


select period,account_no,ytd_debit,ytd_credit,ytd_balance  from Plex.account_period_balance apb
where period = 202107 and ytd_balance is not null

Look back further than 2022-06-28
