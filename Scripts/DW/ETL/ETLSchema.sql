...
-- SET IDENTITY_INSERT ETL.script  ON
--SET IDENTITY_INSERT ETL.script  Off
insert into ETL.script (script_key,Script_Type_Key,name,schedule_key,Source_Control_Repo_Key)
values 
...
(4,2,'AccountingPeriodRanges',1,5)
...
select * from ETL.script_history
where Start_Time > '2022-12-19'
order by  End_Time desc 

-- delete from ETL.Script_History  
where script_key = 1
and Start_Time > '2022-12-14'
