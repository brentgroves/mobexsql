...
EXEC Plex.accounting_balance_get_period_range @pcn,@period_start output,@period_end output,@open_period output,@no_update output

select @period_start period_start,@period_end period_end,@open_period open_period, @no_update no_update;
