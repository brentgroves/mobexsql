select top 10 *
-- select count(*) 
from repsys1.Plex.trial_balance_multi_level_py -- 4,204


CREATE TABLE repsys1.Plex.trial_balance_multi_level_py (
	pcn int NULL,
	period int NULL,
...
CREATE TABLE repsys1.Plex.trial_balance_multi_level (
	pcn int NULL,
	period int NULL,
	period_display varchar(7) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	category_type varchar(10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE repsys1.Plex.account_period_balance (
	pcn int NULL,
...
CREATE TABLE repsys1.Plex.account_activity_summary (
	pcn int NOT NULL,
	period int NOT NULL,
	account_no varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE repsys1.Plex.accounting_balance (
	pcn int NOT NULL,
...
CREATE TABLE repsys1.Plex.accounting_period_ranges (
...
CREATE TABLE repsys1.Plex.accounting_period (
	pcn int NOT NULL,
...
CREATE TABLE repsys1.Plex.accounting_account (
	pcn int NOT NULL,
	account_key int NOT NULL,
	account_no varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	account_name varchar(110) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE repsys1.Plex.accounting_account_year_category_type (
	id int IDENTITY(1,1) NOT NULL,
	pcn int NULL,
	account_no varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[year] int NULL,
...
select top 10 *
-- select count(*) 
from repsys1.Plex.Account_Balances_by_Periods -- 705,481


CREATE TABLE repsys1.Plex.Account_Balances_by_Periods (
	pcn int NULL,
