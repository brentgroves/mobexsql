...
-- cribmaster.Validation.Detailed_Production_History definition

-- Drop table

-- DROP TABLE cribmaster.Validation.Detailed_Production_History;

CREATE TABLE cribmaster.Validation.Detailed_Production_History (
	PCN int NULL,
...
select count(*) cnt from Validation.Detailed_Production_History dph 
